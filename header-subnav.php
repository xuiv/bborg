	...
	<div id="subnav"><div id="subnav-inner">
		...
		<ul id="nav-user" class="menu">
			<?php if ( ! is_user_logged_in() ) : ?>
				<li><a href="<?php echo home_url( '/' ).'wp-login.php?action=register'; ?>"><?php esc_html_e( 'Register', 'bborg' ); ?></a></li>
				<li><a href="<?php echo home_url( '/' ).'wp-login.php?action=lostpassword'; ?>"><?php esc_html_e( 'Lost Password', 'bborg' ); ?></a></li>
