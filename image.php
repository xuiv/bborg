...
if ( have_posts() ) :
	while ( have_posts() ) :
		...
		<dl id="meta">
			<dt><?php esc_html_e( 'Published on', 'bborg' ); ?></dt>
			<dd>
				<?php
			...
			<dt><?php esc_html_e( 'Categorized under', 'bborg' ); ?></dt>
			...
			<dt><?php esc_html_e( 'Syndication through', 'bborg' ); ?></dt>
			<dd><?php comments_rss_link('RSS 2.0'); ?></dd>
			<?php if ('open' == $post->ping_status) : ?>
			<dt><?php esc_html_e( 'Trackback from', 'bborg' ); ?></dt>
			<dd><a href="<?php trackback_url(); ?>" rel="trackback"><?php esc_html_e( 'your own site', 'bborg' ); ?></a></dd>
			<?php endif;
				if ( 'open' == $post->comment_status ) :
					_e( '<dt>Respond if</dt><dd><a href="#respond">you&#8217;d like to leave feedback</a></dd>', 'bborg' );
				endif;
				edit_post_link( esc_html__( 'Edit', 'bborg' ), "\t\t\t\t\t<dt>" . esc_html__( 'You can', 'bborg' ) . "</dt>\n\t\t\t\t\t<dd>", "</dd>\n");
			?>
		</dl>
		<hr class="hidden" />

		<h3><?php esc_html_e( 'View Older or Newer Images', 'bborg' ); ?></h3>
